...
<div style="color: #777;background-color:white;text-align:center;padding:50px 80px;text-align: justify;height:90%;">
  <h3 style="text-align:center; font-family: 'Lora', serif; font-style: italic; font-size: 35px;">We keep it classy.</h3>
  ...
  <div id="homedesc">
      ...
      <div class="button"><a style="text-decoration: none; color: white;" href="products.php">Check it out</a></div>
  </div>
  ...
  <div id="homedesc">
      ...
      <div class="button"><a style="text-decoration: none; color: white;" href="customizer.php">Check it out</a></div>
  </div>
  ...
  <div id="homedesc">
      ...
      <div class="button"><a style="text-decoration: none; color: white;" href="uploader.php">Check it out</a></div>
  </div>
</div>
