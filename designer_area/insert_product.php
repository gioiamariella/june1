	...
	<body>
		...
		<form action = "insert_product.php" method = "post" enctype = "multipart/form-data">
			<table align="center" width="700" bgcolor="orange">
				...
				<tr>
					<td align="center">Product Paper Kind:</td>
					<td>
				...
				<tr>
					<td align="center">Product Print Finish:</td>
					<td>
...
<?php
	if(isset($_POST['insert_post'])) {
		...
		$insert_product="insert into products (product_cat,product_title,product_paperkind,product_printfinish,product_price,product_desc,product_keywords) values ($product_cat,'$product_title',$product_pk,$product_pf,$product_price,'$product_desc','$product_keywords')";
